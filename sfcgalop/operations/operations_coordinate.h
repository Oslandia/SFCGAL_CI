 ...
 */
OperationResult
op_drop_z(const char *op_arg, const sfcgal_geometry_t *geom_a,
 ...
 */
OperationResult
op_drop_m(const char *op_arg, const sfcgal_geometry_t *geom_a,
          const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_force_lhr(const char *op_arg, const sfcgal_geometry_t *geom_a,
             const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_force_rhr(const char *op_arg, const sfcgal_geometry_t *geom_a,
             const sfcgal_geometry_t *geom_b);
