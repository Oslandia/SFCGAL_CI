 ...
 */
OperationResult
op_tesselate(const char *op_arg, const sfcgal_geometry_t *geom_a,
 ...
 */
OperationResult
op_triangulate_2dz(const char *op_arg, const sfcgal_geometry_t *geom_a,
                   const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_y_monotone_partition(const char *op_arg, const sfcgal_geometry_t *geom_a,
                        const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_approx_convex_partition(const char *op_arg, const sfcgal_geometry_t *geom_a,
                           const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_greene_approx_convex_partition(const char              *op_arg,
 ...
 */
OperationResult
op_optimal_convex_partition(const char *op_arg, const sfcgal_geometry_t *geom_a,
                            const sfcgal_geometry_t *geom_b);
