/**
 * operations_transformation.c - Implementation of geometry transformation operations
 */
 ...
 */
OperationResult op_rotate(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
 ...
 */
OperationResult op_rotate_2d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_rotate_3d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_rotate_3d_around_center(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_rotate_x(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_rotate_y(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_rotate_z(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_scale(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_scale_3d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_scale_3d_around_center(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_translate_2d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_translate_3d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_extrude(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_round(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_buffer3d(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
    ...
    if (!parse_double_parameter(op_arg, "radius", 0, 1.0, &radius) ||
        ...
        !parse_double_parameter(op_arg, "buffer_type", 2, 0.0, &buffer_type_val)) {
        result.error = true;
        result.error_message = "Invalid parameter value(s)";
        return result;
    }
 ...
 */
OperationResult op_offset_polygon(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_line_substring(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
 ...
 */
OperationResult op_simplify(const char* op_arg, sfcgal_geometry_t* geom_a, sfcgal_geometry_t* geom_b) {
    OperationResult result = {
        .type = RESULT_GEOMETRY,
        .error = false
    };
    ...
    if (!parse_double_parameter(op_arg, "threshold", 0, 1.0, &threshold) ||
        !parse_bool_parameter(op_arg, "preserve_topology", 1, true, &preserve_topology)) {
        result.error = true;
        result.error_message = "Invalid parameter value(s)";
        return result;
    }
