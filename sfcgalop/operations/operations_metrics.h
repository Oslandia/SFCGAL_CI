 ...
 */
OperationResult
op_distance(const char *op_arg, const sfcgal_geometry_t *geom_a,
 ...
 */
OperationResult
op_distance_3d(const char *op_arg, const sfcgal_geometry_t *geom_a,
               const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_volume(const char *op_arg, const sfcgal_geometry_t *geom_a,
          const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_area(const char *op_arg, const sfcgal_geometry_t *geom_a,
        const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_area_3d(const char *op_arg, const sfcgal_geometry_t *geom_a,
           const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_length(const char *op_arg, const sfcgal_geometry_t *geom_a,
          const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_length_3d(const char *op_arg, const sfcgal_geometry_t *geom_a,
             const sfcgal_geometry_t *geom_b);
 ...
 */
OperationResult
op_orientation(const char *op_arg, const sfcgal_geometry_t *geom_a,
               const sfcgal_geometry_t *geom_b);
