...
///
auto
straightSkeleton(const Geometry &g, bool autoOrientation, NoValidityCheck /*unused*/,
    ...
    -> std::unique_ptr<MultiLineString>
{
  ...
  boost::shared_ptr<Straight_skeleton_2> const skeleton = straightSkeleton(polygon);
