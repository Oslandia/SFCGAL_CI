...
public:
  ...
  /**
   * @brief Returns the dimension of the curve
   * @return 1 for curves
   */
  [[nodiscard]] auto
  ...
  /**
   * @brief Returns the coordinate dimension
   ...
   */
  [[nodiscard]] auto
  isValidParameter(Parameter parameter) const -> bool;
   ...
   */
  [[nodiscard]] auto
  normalizeParameter(Parameter parameter) const -> FT;
   ...
   */
  [[nodiscard]] auto
  denormalizeParameter(FT normalizedParameter) const -> Parameter;
};
