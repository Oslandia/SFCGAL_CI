...
BOOST_AUTO_TEST_CASE(testSurfaceArea)
{
  ...
  BOOST_CHECK_CLOSE(cone.area(), expected_area, 1e-5);
  BOOST_CHECK_CLOSE(cone.area(false), expected_area, 1e-5);
  BOOST_CHECK_CLOSE(cone.area(true), expected_discretized_area, 1e-5);
  ...
  BOOST_CHECK_EQUAL(cone.area(), expected_area);
  BOOST_CHECK_EQUAL(cone.area(false), expected_area);
  BOOST_CHECK_EQUAL(cone.area(true), expected_discretized_area);
}
